...
server2.on('request', (req, res) => {
    fs.readFile("./Lemon.mp3", (err, data) => {
...
server3.on('request', (req, res) => {
    fs.readFile("./Jaemin Cam.mp4", (err, data) => {
...
server4.on('request', (req, res) => {
        res.writeHead(302, {'Location':'http://naver.com'});    //강제 페이지 이동 구현 코드번호 : 302
        res.end();
});
server4.listen(3003, () => {
